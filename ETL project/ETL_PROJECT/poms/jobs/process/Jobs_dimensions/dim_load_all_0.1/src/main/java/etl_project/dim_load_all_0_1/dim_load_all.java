...
package etl_project.dim_load_all_0_1;
 ...
 * @status
 */
public class dim_load_all implements TalendJob {
	...
	private final String jobName = "dim_load_all";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dim_load_all.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row_Implicit_Context_RegexStruct
		...
		final static byte[] commonByteArrayLock_ETL_PROJECT_dim_load_all = new byte[0];
		static byte[] commonByteArray_ETL_PROJECT_dim_load_all = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ETL_PROJECT_dim_load_all.length) {
					if (length < 1024 && commonByteArray_ETL_PROJECT_dim_load_all.length == 0) {
						commonByteArray_ETL_PROJECT_dim_load_all = new byte[1024];
					} else {
						commonByteArray_ETL_PROJECT_dim_load_all = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ETL_PROJECT_dim_load_all, 0, length);
				strReturn = new String(commonByteArray_ETL_PROJECT_dim_load_all, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PROJECT_dim_load_all) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:ibx1ab1RxMSkoU7s2AqKcmljmi7Nt4TMbBZf8w==");
...
// For MapReduce Mode
	...
	public static void main(String[] args) {
		final dim_load_all dim_load_allClass = new dim_load_all();

		int exitCode = dim_load_allClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_load_all.class.getClassLoader()
					.getResourceAsStream("etl_project/dim_load_all_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_load_all.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_load_all");
		}
...
/************************************************************************************************
 * 70031 characters generated by Talend Open Studio for Big Data on the 24
 * octobre 2025 19:05:08 CEST
 ************************************************************************************************/