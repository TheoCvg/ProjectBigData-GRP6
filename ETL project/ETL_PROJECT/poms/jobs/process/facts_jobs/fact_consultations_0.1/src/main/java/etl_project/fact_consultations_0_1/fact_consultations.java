...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		try {
			...
			public void tHiveInput_5_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tHadoopConfManager_tHiveCreateTable_1_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tHadoopConfManager_tHiveInput_5_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tHadoopConfManager_tHiveCreateTable_1_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tHadoopConfManager_tHiveInput_5_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class fact_consultations_outputStruct implements routines.system.IPersistableRow<fact_consultations_outputStruct> {
    final static byte[] commonByteArrayLock_ETL_PROJECT_fact_consultations = new byte[0];
    static byte[] commonByteArray_ETL_PROJECT_fact_consultations = new byte[0];
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/talend/warehouse/f_consultations/f_consultations.txt");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.postgres_DB_input_Password; 
				...
				String url_tDBInput_1 = "jdbc:postgresql://" + context.postgres_DB_input_Server + ":" + context.postgres_DB_input_Port + "/" + context.postgres_DB_input_Database + "?" + context.postgres_DB_input_AdditionalParams;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(!tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.code_diag = '" + row3HashKey.code_diag + "'");
								} // G 071
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(!tHash_Lookup_row4.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.id_patient = '" + row4HashKey.id_patient + "'");
								} // G 071
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(!tHash_Lookup_row5.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.id_healthcare_professional = '" + row5HashKey.id_healthcare_professional + "'");
								} // G 071
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
	...
	final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:IN1Z1bI8LJ2o/TY2fh8mTeLkTT1mtY16IJc2jQ==");
...
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE IF NOT EXISTS " + tableName_tHiveCreateTable_1 + "(id_consultation INT,Motif STRING,id_date INT,id_diagnostic STRING,id_patient INT,id_healthcare_professional STRING,id_organisation STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE LOCATION '" + location_tHiveCreateTable_1 + "'";
		try {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// source node:tHiveInput_1 - inputs:(after_tDBInput_1) outputs:(row2,row2) | target node:tAdvancedHash_row2 - inputs:(row2) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row2,row3,row4,row5) outputs:(fact_consultations_output)
 ...
 */
	...
	final String decryptedPassword_tHiveInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Htx6EH69MRt+imt6WkDoOHeQvAetyP9zOj+bNQ==");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// source node:tHiveInput_2 - inputs:(after_tDBInput_1) outputs:(row3,row3) | target node:tAdvancedHash_row3 - inputs:(row3) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row2,row3,row4,row5) outputs:(fact_consultations_output)
 ...
 */
	...
	final String decryptedPassword_tHiveInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:N5qW8Iwt0m4+f8EJu8+r/fvQU8ropIWmlbCz+Q==");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// source node:tHiveInput_5 - inputs:(after_tDBInput_1) outputs:(row4,row4) | target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row2,row3,row4,row5) outputs:(fact_consultations_output)
 ...
 */
	...
	final String decryptedPassword_tHiveInput_5 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Lvlxh/ydr0C3WZzMTMdpkLwYFlSrzs+mlrLNqA==");
			...
			globalMap.put("HADOOP_USER_NAME_tHiveInput_5", System.getProperty("HADOOP_USER_NAME"));
				...
				conn_tHiveInput_5 = java.sql.DriverManager.getConnection(url_tHiveInput_5,dbUser_tHiveInput_5,dbPwd_tHiveInput_5);
        	...
        	if(dbname_tHiveInput_5!=null && !"".equals(dbname_tHiveInput_5.trim()) && !"default".equals(dbname_tHiveInput_5.trim())) {
...
final String queryIdentifier_tHiveInput_5 = projectName + "_" + jobName + "_" + jobVersion.replace(".", "_") + "_tHiveInput_5_" + dateStrFormat_tHiveInput_5.format(new Date(startTime));
// For MapReduce Mode
...
String currentClientPathSeparator_tHiveInput_5 = (String)globalMap.get("current_client_path_separator");
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.id_healthcare_professional == null) ? 0 : this.id_healthcare_professional.hashCode());
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row5";
		...
		int tos_count_tAdvancedHash_row5 = 0;
			   		...
			   		// source node:tHiveInput_3 - inputs:(after_tDBInput_1) outputs:(row5,row5) | target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row2,row3,row4,row5) outputs:(fact_consultations_output)
 ...
 */
	...
	final String decryptedPassword_tHiveInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:KT0H2bT5vnQqEjy5UuZV1Ecc34HoAzl5dAeLEA==");
...
+"healthcare_professionnals";
        	...
        	row5.id_healthcare_professional = routines.system.JDBCUtil.getString(rs_tHiveInput_3, 1, false);
		                    }
...
public void tHadoopConfManager_tHiveCreateTable_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
...
String confJarName = dealJobLibrary.getConfJarName("hadoop-conf-ClusterHadopp.jar", this.contextStr);
    ...
    libPath_tHadoopConfManager_tHiveCreateTable_1 = new java.io.File("C:/Users/theoc/Desktop/notion/A4/Blocs/BigData/Projet/ProjectBigData-GRP6/ETL project/ETL_PROJECT/temp/lib/" + confJarName).getAbsolutePath();
libPath_tHadoopConfManager_tHiveCreateTable_1 = dealJobLibrary.replaceJarPathsFromCrcMap(libPath_tHadoopConfManager_tHiveCreateTable_1);

java.net.URLClassLoader currentLoadertHadoopConfManager_tHiveCreateTable_1 = (java.net.URLClassLoader) Thread.currentThread().getContextClassLoader();
java.lang.reflect.Method method_tHadoopConfManager_tHiveCreateTable_1 = java.net.URLClassLoader.class.getDeclaredMethod("addURL", new Class[] { java.net.URL.class });
method_tHadoopConfManager_tHiveCreateTable_1.setAccessible(true);
method_tHadoopConfManager_tHiveCreateTable_1.invoke(currentLoadertHadoopConfManager_tHiveCreateTable_1, new Object[] { new java.io.File(libPath_tHadoopConfManager_tHiveCreateTable_1).toURL() });
...
public void tHadoopConfManager_tHiveInput_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
...
String confJarName = dealJobLibrary.getConfJarName("hadoop-conf-ClusterHadopp.jar", this.contextStr);
    ...
    libPath_tHadoopConfManager_tHiveInput_5 = new java.io.File("C:/Users/theoc/Desktop/notion/A4/Blocs/BigData/Projet/ProjectBigData-GRP6/ETL project/ETL_PROJECT/temp/lib/" + confJarName).getAbsolutePath();
libPath_tHadoopConfManager_tHiveInput_5 = dealJobLibrary.replaceJarPathsFromCrcMap(libPath_tHadoopConfManager_tHiveInput_5);

java.net.URLClassLoader currentLoadertHadoopConfManager_tHiveInput_5 = (java.net.URLClassLoader) Thread.currentThread().getContextClassLoader();
java.lang.reflect.Method method_tHadoopConfManager_tHiveInput_5 = java.net.URLClassLoader.class.getDeclaredMethod("addURL", new Class[] { java.net.URL.class });
method_tHadoopConfManager_tHiveInput_5.setAccessible(true);
method_tHadoopConfManager_tHiveInput_5.invoke(currentLoadertHadoopConfManager_tHiveInput_5, new Object[] { new java.io.File(libPath_tHadoopConfManager_tHiveInput_5).toURL() });
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = fact_consultations.class.getClassLoader().getResourceAsStream("etl_project/fact_consultations_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = fact_consultations.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : fact_consultations");
        }
...
/************************************************************************************************
 *     232459 characters generated by Talend Open Studio for Big Data 
 *     on the 30 octobre 2025 11:15:25 CET
 ************************************************************************************************/