		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						"/user/talend/warehouse/d_diagnostics/d_diagnostics.txt");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:D78wDNS6VEzs7X0xT7UEofKYHdPtqQ3MJueqEg==");
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE IF NOT EXISTS " + tableName_tHiveCreateTable_1
						+ "(Code_diag VARCHAR(1000),Diagnostic VARCHAR(1000)) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
...
// For MapReduce Mode
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_diagnostics.class.getClassLoader()
					.getResourceAsStream("etl_project/dim_diagnostics_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_diagnostics.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_diagnostics");
		}
...
/************************************************************************************************
 * 93514 characters generated by Talend Open Studio for Big Data on the 28
 * octobre 2025 15:51:59 CET
 ************************************************************************************************/