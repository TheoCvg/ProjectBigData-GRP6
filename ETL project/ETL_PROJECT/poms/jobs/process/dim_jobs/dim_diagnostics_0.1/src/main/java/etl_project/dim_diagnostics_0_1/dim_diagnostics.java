...
package etl_project.dim_diagnostics_0_1;
...
/**
 * Job: dim_diagnostics Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class dim_diagnostics implements TalendJob {
...
public String getClusterHadopp_hadoopConfSpecificJar(){
	...
	private final String jobName = "dim_diagnostics";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dim_diagnostics.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dim_diagnostics.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_ETL_PROJECT_dim_diagnostics = new byte[0];
    static byte[] commonByteArray_ETL_PROJECT_dim_diagnostics = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ETL_PROJECT_dim_diagnostics.length) {
				if(length < 1024 && commonByteArray_ETL_PROJECT_dim_diagnostics.length == 0) {
   					commonByteArray_ETL_PROJECT_dim_diagnostics = new byte[1024];
				} else {
   					commonByteArray_ETL_PROJECT_dim_diagnostics = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ETL_PROJECT_dim_diagnostics, 0, length);
			strReturn = new String(commonByteArray_ETL_PROJECT_dim_diagnostics, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ETL_PROJECT_dim_diagnostics) {
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/talend/warehouse/d_diagnostics/d_diagnostics.txt");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.postgres_DB_input_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT \"Code_diag\", \"Diagnostic\" FROM \"Diagnostic\"";
...
row2 = null;			
finder_tUniqRow_1.Code_diag = row1.Code_diag;	
finder_tUniqRow_1.hashCodeDirty = true;
if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
		KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

		
new_tUniqRow_1.Code_diag = row1.Code_diag;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
	...
	final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:vnTcoQvnwSwKt0Qg2Fc2E4BXAjfY6mkGRs+6AQ==");
    ...
    String tableName_tHiveCreateTable_1 = "d_diagnostics";
            String fieldChar_tHiveCreateTable_1 = ";";
    String location_tHiveCreateTable_1 = "/user/talend/warehouse/d_diagnostics/";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE IF NOT EXISTS " + tableName_tHiveCreateTable_1 + "(Code_diag VARCHAR(1000),Diagnostic VARCHAR(1000)) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE LOCATION '" + location_tHiveCreateTable_1 + "'";
		try {
 ...
 */
    ...
    public static void main(String[] args){
        final dim_diagnostics dim_diagnosticsClass = new dim_diagnostics();

        int exitCode = dim_diagnosticsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dim_diagnostics.class.getClassLoader().getResourceAsStream("etl_project/dim_diagnostics_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dim_diagnostics.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_diagnostics");
        }
...
/************************************************************************************************
 *     93514 characters generated by Talend Open Studio for Big Data 
 *     on the 30 octobre 2025 11:06:07 CET
 ************************************************************************************************/