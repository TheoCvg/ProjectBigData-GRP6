...
package etl_project.dim_healthcare_professionals_0_1;
...
/**
 * Job: dim_healthcare_professionals Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class dim_healthcare_professionals implements TalendJob {
...
public String getINPUT_PATH(){
	...
	private final String jobName = "dim_healthcare_professionals";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dim_healthcare_professionals.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dim_healthcare_professionals.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_ETL_PROJECT_dim_healthcare_professionals = new byte[0];
    static byte[] commonByteArray_ETL_PROJECT_dim_healthcare_professionals = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ETL_PROJECT_dim_healthcare_professionals.length) {
				if(length < 1024 && commonByteArray_ETL_PROJECT_dim_healthcare_professionals.length == 0) {
   					commonByteArray_ETL_PROJECT_dim_healthcare_professionals = new byte[1024];
				} else {
   					commonByteArray_ETL_PROJECT_dim_healthcare_professionals = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ETL_PROJECT_dim_healthcare_professionals, 0, length);
			strReturn = new String(commonByteArray_ETL_PROJECT_dim_healthcare_professionals, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ETL_PROJECT_dim_healthcare_professionals) {
...
public static class d_healthcare_professionnelStruct implements routines.system.IPersistableRow<d_healthcare_professionnelStruct> {
    final static byte[] commonByteArrayLock_ETL_PROJECT_dim_healthcare_professionals = new byte[0];
    static byte[] commonByteArray_ETL_PROJECT_dim_healthcare_professionals = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final d_healthcare_professionnelStruct other = (d_healthcare_professionnelStruct) obj;
	...
	public void copyDataTo(d_healthcare_professionnelStruct other) {
	...
	public void copyKeysDataTo(d_healthcare_professionnelStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(d_healthcare_professionnelStruct other) {
...
public static class after_tFileInputDelimited_1Struct implements routines.system.IPersistableRow<after_tFileInputDelimited_1Struct> {
	...
	public void copyDataTo(after_tFileInputDelimited_1Struct other) {
		...
		other.identifiant = this.identifiant;
	            ...
	            other.categorie_professionnelle = this.categorie_professionnelle;
	            other.nom = this.nom;
	            other.prenom = this.prenom;
	            other.commune = this.commune;
	            other.profession = this.profession;
	            other.specialite = this.specialite;
	            other.type_identifiant = this.type_identifiant;
...
d_healthcare_professionnelStruct d_healthcare_professionnel = new d_healthcare_professionnelStruct();
	...
	currentComponent="tHDFSOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"d_healthcare_professionnel");
					}
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/talend/warehouse/d_healthcare_professionnals/d_healthcare_professionnals.txt");
...
d_healthcare_professionnelStruct d_healthcare_professionnel_tmp = new d_healthcare_professionnelStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = context.INPUT_PATH + "professionnel_sante.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.INPUT_PATH + "professionnel_sante.csv", "ISO-8859-15",";","\n",true,0,0,
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.identifiant = row1.identifiant ;
...
d_healthcare_professionnel = null;


// # Output table : 'd_healthcare_professionnel'
d_healthcare_professionnel_tmp.id_healthcare_professional = row1.identifiant ;
d_healthcare_professionnel_tmp.Surname = row1.nom ;
d_healthcare_professionnel_tmp.Name = row1.prenom ;
d_healthcare_professionnel_tmp.Profession = row1.profession ;
d_healthcare_professionnel_tmp.Speciality = row1.specialite ;
d_healthcare_professionnel_tmp.id_organisation = row2.identifiant_organisation ;
d_healthcare_professionnel = d_healthcare_professionnel_tmp;
// ###############################
 ...
 */
// Start of branch "d_healthcare_professionnel"
if(d_healthcare_professionnel != null) { 
	...
	currentComponent="tHDFSOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"d_healthcare_professionnel");
					}
					...
					StringBuilder sb_tHDFSOutput_1 = new StringBuilder();
								...
								if(d_healthcare_professionnel.id_healthcare_professional != null) {
							
									sb_tHDFSOutput_1.append(
										
											d_healthcare_professionnel.id_healthcare_professional
								...
								if(d_healthcare_professionnel.Surname != null) {
							
									sb_tHDFSOutput_1.append(
										
											d_healthcare_professionnel.Surname
								...
								if(d_healthcare_professionnel.Name != null) {
							
									sb_tHDFSOutput_1.append(
										
											d_healthcare_professionnel.Name
								...
								if(d_healthcare_professionnel.Profession != null) {
							
									sb_tHDFSOutput_1.append(
										
											d_healthcare_professionnel.Profession
								...
								if(d_healthcare_professionnel.Speciality != null) {
							
									sb_tHDFSOutput_1.append(
										
											d_healthcare_professionnel.Speciality
								...
								if(d_healthcare_professionnel.id_organisation != null) {
							
									sb_tHDFSOutput_1.append(
										
											d_healthcare_professionnel.id_organisation
...
} // End of branch "d_healthcare_professionnel"
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(context.INPUT_PATH + "professionnel_sante.csv") instanceof java.io.InputStream)){
	...
	currentComponent="tHDFSOutput_1";
		...
		if(outtHDFSOutput_1!=null){
			outtHDFSOutput_1.close();
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"d_healthcare_professionnel");
			  	}
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
	...
	final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:5gDYqc7rEcEJtU1qD9uE4oNTZikll3EEWfignA==");
    ...
    String tableName_tHiveCreateTable_1 = "d_healthcare_professionnals";
            String fieldChar_tHiveCreateTable_1 = ";";
    String location_tHiveCreateTable_1 = "/user/talend/warehouse/d_healthcare_professionnals/";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE IF NOT EXISTS " + tableName_tHiveCreateTable_1 + "(id_healthcare_professional STRING,Surname STRING,Name STRING,Profession STRING,Speciality STRING,id_organisation STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE LOCATION '" + location_tHiveCreateTable_1 + "'";
		try {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(d_healthcare_professionnel)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_2 = context.INPUT_PATH + "activite_professionnel_sante.csv" ;
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(context.INPUT_PATH + "activite_professionnel_sante.csv" , "ISO-8859-15",";","\n",true,0,0,
 ...
 */
	...
	currentComponent="tFileInputDelimited_2";
                ...
                if(!((Object)(context.INPUT_PATH + "activite_professionnel_sante.csv" ) instanceof java.io.InputStream)){
 ...
 */
    ...
    public static void main(String[] args){
        final dim_healthcare_professionals dim_healthcare_professionalsClass = new dim_healthcare_professionals();

        int exitCode = dim_healthcare_professionalsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dim_healthcare_professionals.class.getClassLoader().getResourceAsStream("etl_project/dim_healthcare_professionals_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dim_healthcare_professionals.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("ClusterHadopp_User")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_healthcare_professionals");
        }
...
/************************************************************************************************
 *     119050 characters generated by Talend Open Studio for Big Data 
 *     on the 30 octobre 2025 11:06:10 CET
 ************************************************************************************************/