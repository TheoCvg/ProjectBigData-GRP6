				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dim_healthcare_professionals.this,
	...
	public static class row_Implicit_Context_RegexStruct
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				strReturn = new String(commonByteArray_ETL_PROJECT_dim_healthcare_professionals, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
...
// Start of branch "row_Implicit_Context_Regex"
	...
	public static class d_healthcare_professionnelStruct
			implements routines.system.IPersistableRow<d_healthcare_professionnelStruct> {
		final static byte[] commonByteArrayLock_ETL_PROJECT_dim_healthcare_professionals = new byte[0];
		static byte[] commonByteArray_ETL_PROJECT_dim_healthcare_professionals = new byte[0];
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						"/user/talend/warehouse/d_healthcare_professionnals/d_healthcare_professionnals.txt");
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.INPUT_PATH + "professionnel_sante.csv", "ISO-8859-15", ";", "\n", true, 0, 0,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:pv6XPUQzVn6qpS8jy9KRxgAEACZUvZ/RqIPppA==");
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE IF NOT EXISTS " + tableName_tHiveCreateTable_1
						+ "(id_healthcare_professional STRING,Surname STRING,Name STRING,Profession STRING,Speciality STRING,id_organisation STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
				...
				try {
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								context.INPUT_PATH + "activite_professionnel_sante.csv", "ISO-8859-15", ";", "\n", true,
								0, 0, limit_tFileInputDelimited_2, -1, false);
					} catch (java.lang.Exception e) {
...
// Start of branch "row2"
					...
					if (!((Object) (context.INPUT_PATH
							+ "activite_professionnel_sante.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_healthcare_professionals.class.getClassLoader().getResourceAsStream(
					"etl_project/dim_healthcare_professionals_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_healthcare_professionals.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : dim_healthcare_professionals");
		}
...
/************************************************************************************************
 * 119050 characters generated by Talend Open Studio for Big Data on the 29
 * octobre 2025 10:14:40 CET
 ************************************************************************************************/