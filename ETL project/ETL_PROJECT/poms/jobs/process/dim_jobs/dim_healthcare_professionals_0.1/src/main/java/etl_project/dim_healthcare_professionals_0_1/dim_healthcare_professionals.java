...
java.sql.Connection conn_tHiveCreateTable_1 = null;
	...
	final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:hnYYFV2LgXTCxATCurzdvuphpRHoPtt0+rFmTQ==");
...
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE IF NOT EXISTS " + tableName_tHiveCreateTable_1 + "(id_healthcare_professional STRING,Surname STRING,Name STRING,Profession STRING,Speciality STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE LOCATION '" + location_tHiveCreateTable_1 + "'";
		try {
...
/************************************************************************************************
 *     91462 characters generated by Talend Open Studio for Big Data 
 *     on the 27 octobre 2025 22:29:21 CET
 ************************************************************************************************/