...
package etl_project.dim_dates_0_1;
...
/**
 * Job: dim_dates Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class dim_dates implements TalendJob {
...
public String getClusterHadopp_JobHistory(){
	...
	private final String jobName = "dim_dates";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dim_dates.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_ETL_PROJECT_dim_dates = new byte[0];
    static byte[] commonByteArray_ETL_PROJECT_dim_dates = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ETL_PROJECT_dim_dates.length) {
				if(length < 1024 && commonByteArray_ETL_PROJECT_dim_dates.length == 0) {
   					commonByteArray_ETL_PROJECT_dim_dates = new byte[1024];
				} else {
   					commonByteArray_ETL_PROJECT_dim_dates = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ETL_PROJECT_dim_dates, 0, length);
			strReturn = new String(commonByteArray_ETL_PROJECT_dim_dates, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ETL_PROJECT_dim_dates) {
...
public static class dates_hospitalization_outputStruct implements routines.system.IPersistableRow<dates_hospitalization_outputStruct> {
    final static byte[] commonByteArrayLock_ETL_PROJECT_dim_dates = new byte[0];
    static byte[] commonByteArray_ETL_PROJECT_dim_dates = new byte[0];
...
public static class date_naissance_outputStruct implements routines.system.IPersistableRow<date_naissance_outputStruct> {
    final static byte[] commonByteArrayLock_ETL_PROJECT_dim_dates = new byte[0];
    static byte[] commonByteArray_ETL_PROJECT_dim_dates = new byte[0];
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/talend/warehouse/d_dates/d_dates.txt");
	int nb_line_tHDFSOutput_1 = 0;
		...
		org.apache.hadoop.fs.FSDataOutputStream fsDataOutputStream_tHDFSOutput_1 = null;
			...
			outtHDFSOutput_1=new java.io.BufferedWriter(new java.io.OutputStreamWriter(fsDataOutputStream_tHDFSOutput_1,"UTF-8"));
 ...
 */
	...
	currentComponent="tUnite_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"date_naissance_output","dates_hospitalization_output","row1");
					}
...
row5 = null;			
finder_tUniqRow_1.Date = row4.Date;	
finder_tUniqRow_1.hashCodeDirty = true;
if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
		KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

		
new_tUniqRow_1.Date = row4.Date;
					...
					StringBuilder sb_tHDFSOutput_1 = new StringBuilder();
								...
								if(d_dates_output.Date != null) {
									...
									sb_tHDFSOutput_1.append(
											...
											FormatterUtils.format_Date(d_dates_output.Date, "yyyy-MM-dd HH:mm:ss")
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(context.INPUT_PATH + "Hospitalisations.csv", "ISO-8859-15",";","\n",true,1,0,
				...
				int columnIndexWithD_tFileInputDelimited_2 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"Num_Hospitalisation", "row3", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 1;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"Id_patient", "row3", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 2;
							...
							row3.identifiant_organisation = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 3;
					
							row3.Code_diagnostic = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 4;
					
							row3.Suite_diagnostic_consultation = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
					...
					columnIndexWithD_tFileInputDelimited_2 = 6;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"Jour_Hospitalisation", "row3", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
dates_hospitalization_output_tmp.Date = row3.Date_Entree == null || row3.Date_Entree.trim().isEmpty()
? null
: (
    !row3.Date_Entree.replaceAll("/", "-").matches("^\\d{4}-\\d{2}-\\d{2}$")
    ? (
        row3.Date_Entree.replaceAll("-", "/").matches("^\\d{4}$")
        ? TalendDate.parseDate("yyyy-MM-dd", row3.Date_Entree.replaceAll("/", "-") + "-01-01")
        : (
            row3.Date_Entree.replaceAll("-", "/").matches("^\\d{4}/\\d{2}$")
            ? TalendDate.parseDate("yyyy-MM-dd", row3.Date_Entree.replaceAll("/", "-") + "-01")
            : null
        )
      )
    : TalendDate.parseDate("yyyy/MM/dd", row3.Date_Entree.replaceAll("/", "-"))
  );
...
date_naissance_output_tmp.Date =  row2.date_naissance == null || row2.date_naissance.trim().isEmpty()
? null
: (
    ! row2.date_naissance.replaceAll("/", "-").matches("^\\d{4}-\\d{2}-\\d{2}$")
    ? (
         row2.date_naissance.replaceAll("-", "/").matches("^\\d{4}$")
        ? TalendDate.parseDate("yyyy-MM-dd", row2.date_naissance.replaceAll("/", "-") +  "-01-01")
        : (
             row2.date_naissance.replaceAll("-", "/").matches("^\\d{4}/\\d{2}$")
            ? TalendDate.parseDate("yyyy-MM-dd", row2.date_naissance.replaceAll("/", "-") + "-01")
            : null
        )
      )
    : TalendDate.parseDate("yyyy-MM-dd",  row2.date_naissance.replaceAll("/", "-"))
  );
...
globalMap.put("tUnite_1_NB_LINE", nb_line_tUnite_1);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"date_naissance_output","dates_hospitalization_output","row1");
			  	}
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
	...
	final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:U9NnqW/L0FaoMRBWFToQHAisGboloW/jvULiVw==");
    ...
    String location_tHiveCreateTable_1 = "/user/talend/warehouse/d_dates/";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE IF NOT EXISTS " + tableName_tHiveCreateTable_1 + "(Id_date INT,Date TIMESTAMP,Year INT) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE LOCATION '" + location_tHiveCreateTable_1 + "'";
		try {
 ...
 */
    ...
    public static void main(String[] args){
        final dim_dates dim_datesClass = new dim_dates();

        int exitCode = dim_datesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dim_dates.class.getClassLoader().getResourceAsStream("etl_project/dim_dates_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dim_dates.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("postgres_DB_input_Login")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_dates");
        }
...
/************************************************************************************************
 *     155632 characters generated by Talend Open Studio for Big Data 
 *     on the 30 octobre 2025 11:06:06 CET
 ************************************************************************************************/