		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						"/user/talend/warehouse/d_dates/d_dates.txt");
				...
				outtHDFSOutput_1 = new java.io.BufferedWriter(
						new java.io.OutputStreamWriter(fsDataOutputStream_tHDFSOutput_1, "UTF-8"));
...
// ###############################
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "row1", "date_naissance_output",
							"dates_hospitalization_output");
				}
									...
									if (d_dates_output != null) {
										...
										if (d_dates_output.Date != null) {
											...
											sb_tHDFSOutput_1.append(
													...
													FormatterUtils.format_Date(d_dates_output.Date,
															"yyyy-MM-dd HH:mm:ss")
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "row1", "date_naissance_output",
							"dates_hospitalization_output");
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:fINu4CCM9jgGuEXEJGtu4HKDjj6ZAbQU/PmU9A==");
...
// For MapReduce Mode
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_dates.class.getClassLoader()
					.getResourceAsStream("etl_project/dim_dates_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_dates.class.getClassLoader()
...
/************************************************************************************************
 * 155632 characters generated by Talend Open Studio for Big Data on the 27
 * octobre 2025 22:44:19 CET
 ************************************************************************************************/