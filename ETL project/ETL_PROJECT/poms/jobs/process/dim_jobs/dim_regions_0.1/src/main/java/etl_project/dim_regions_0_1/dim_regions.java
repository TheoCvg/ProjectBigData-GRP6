...
public static class regionStruct implements routines.system.IPersistableRow<regionStruct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.Id_reg == null) ? 0 : this.Id_reg.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final regionStruct other = (regionStruct) obj;
						...
						if (this.Id_reg == null) {
							if (other.Id_reg != null)
								return false;
						
						} else if (!this.Id_reg.equals(other.Id_reg))
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/talend/warehouse/d_regions/d_regions.txt");
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */context.INPUT_PATH + "20230823-communes-departement-region.csv"/** End field tFileInputDelimited_2:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.latitude = ParserUtils.parseTo_Float(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
											...
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"latitude", "row1", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.longitude = ParserUtils.parseTo_Float(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_2) {
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"longitude", "row1", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
	...
	final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:g4igfBUTt1U8M2TB9M1j/vJFIrnqFOICw7QQEQ==");
...
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE IF NOT EXISTS " + tableName_tHiveCreateTable_1 + "(Id_reg INT,country STRING,Postcode STRING,town STRING,region STRING,departement STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE LOCATION '" + location_tHiveCreateTable_1 + "'";
		try {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dim_regions.class.getClassLoader().getResourceAsStream("etl_project/dim_regions_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dim_regions.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
/************************************************************************************************
 *     116885 characters generated by Talend Open Studio for Big Data 
 *     on the 30 octobre 2025 11:06:12 CET
 ************************************************************************************************/