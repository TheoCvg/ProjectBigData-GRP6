...
d_etablissement_tmp.id_eta = Numeric.sequence("id_seq", 1, 1);
...
if(d_etablissement != null) { 
	...
	currentComponent="tHDFSOutput_1";
					...
					StringBuilder sb_tHDFSOutput_1 = new StringBuilder();
								...
								if(d_etablissement.identifiant_organisation != null) {
							
									sb_tHDFSOutput_1.append(
										
											d_etablissement.identifiant_organisation
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
	...
	final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Gb96ZfnG8kXCWDmrNz5070ArnL7pWVjI7bF/vw==");
...
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE IF NOT EXISTS " + tableName_tHiveCreateTable_1 + "(id_eta INT,raison_sociale_site STRING,cedex STRING,email STRING,identifiant_organisation STRING,siren_site STRING,siret_site STRING,telecopie STRING,telephone STRING,telephone_2 STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE LOCATION '" + location_tHiveCreateTable_1 + "'";
		try {
...
/************************************************************************************************
 *     113967 characters generated by Talend Open Studio for Big Data 
 *     on the 27 octobre 2025 22:29:20 CET
 ************************************************************************************************/