		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						"/user/talend/warehouse/d_etablissements/d_etablissements.txt");
...
// ###############################
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */
						context.INPUT_PATH + "etablissement_sante.csv"/** End field tFileInputDelimited_1:FILENAME */
				;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:iOThYzEUbdxZJ7PuQ8v1hCVySri7B9c1XHkT1Q==");
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE IF NOT EXISTS " + tableName_tHiveCreateTable_1
						+ "(id_etablissement STRING,raison_sociale_site STRING,cedex STRING,email STRING,siren_site STRING,siret_site STRING,telecopie STRING,telephone STRING,telephone_2 STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
...
// For MapReduce Mode
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_etablissements.class.getClassLoader()
					.getResourceAsStream("etl_project/dim_etablissements_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_etablissements.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_etablissements");
		}
...
/************************************************************************************************
 * 113566 characters generated by Talend Open Studio for Big Data on the 29
 * octobre 2025 09:55:13 CET
 ************************************************************************************************/