...
package etl_project.load_dims_0_1;
...
/**
 * Job: load_dims Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class load_dims implements TalendJob {
...
public String getClusterHadopp_ResourceManagerScheduler(){
	...
	private final String jobName = "load_dims";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(load_dims.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_ETL_PROJECT_load_dims = new byte[0];
    static byte[] commonByteArray_ETL_PROJECT_load_dims = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ETL_PROJECT_load_dims.length) {
				if(length < 1024 && commonByteArray_ETL_PROJECT_load_dims.length == 0) {
   					commonByteArray_ETL_PROJECT_load_dims = new byte[1024];
				} else {
   					commonByteArray_ETL_PROJECT_load_dims = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ETL_PROJECT_load_dims, 0, length);
			strReturn = new String(commonByteArray_ETL_PROJECT_load_dims, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ETL_PROJECT_load_dims) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		etl_project.dim_dates_0_1.dim_dates childJob_tRunJob_1 = new etl_project.dim_dates_0_1.dim_dates();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		etl_project.dim_diagnostics_0_1.dim_diagnostics childJob_tRunJob_2 = new etl_project.dim_diagnostics_0_1.dim_diagnostics();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		etl_project.dim_etablissements_0_1.dim_etablissements childJob_tRunJob_3 = new etl_project.dim_etablissements_0_1.dim_etablissements();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		etl_project.dim_healthcare_professionals_0_1.dim_healthcare_professionals childJob_tRunJob_4 = new etl_project.dim_healthcare_professionals_0_1.dim_healthcare_professionals();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		etl_project.dim_patients_0_1.dim_patients childJob_tRunJob_5 = new etl_project.dim_patients_0_1.dim_patients();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		etl_project.dim_regions_0_1.dim_regions childJob_tRunJob_6 = new etl_project.dim_regions_0_1.dim_regions();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final load_dims load_dimsClass = new load_dims();

        int exitCode = load_dimsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = load_dims.class.getClassLoader().getResourceAsStream("etl_project/load_dims_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = load_dims.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : load_dims");
        }
...
/************************************************************************************************
 *     91179 characters generated by Talend Open Studio for Big Data 
