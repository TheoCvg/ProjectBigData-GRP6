...
// Start of branch "row_Implicit_Context_Regex"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = load_dims.class.getClassLoader()
					.getResourceAsStream("etl_project/load_dims_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = load_dims.class.getClassLoader()
...
/************************************************************************************************
 * 76062 characters generated by Talend Open Studio for Big Data on the 27
 * octobre 2025 22:29:22 CET
 ************************************************************************************************/