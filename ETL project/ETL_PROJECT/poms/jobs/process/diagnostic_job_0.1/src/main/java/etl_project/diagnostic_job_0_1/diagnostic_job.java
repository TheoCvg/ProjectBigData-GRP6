...
package etl_project.diagnostic_job_0_1;
 ...
 * @status
 */
public class diagnostic_job implements TalendJob {
	...
	private final String jobName = "diagnostic_job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					diagnostic_job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(diagnostic_job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row_Implicit_Context_RegexStruct
		...
		final static byte[] commonByteArrayLock_ETL_PROJECT_diagnostic_job = new byte[0];
		static byte[] commonByteArray_ETL_PROJECT_diagnostic_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ETL_PROJECT_diagnostic_job.length) {
					if (length < 1024 && commonByteArray_ETL_PROJECT_diagnostic_job.length == 0) {
						commonByteArray_ETL_PROJECT_diagnostic_job = new byte[1024];
					} else {
						commonByteArray_ETL_PROJECT_diagnostic_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ETL_PROJECT_diagnostic_job, 0, length);
				strReturn = new String(commonByteArray_ETL_PROJECT_diagnostic_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PROJECT_diagnostic_job) {
...
// ------------
				...
				System.err.println(
						...
						"Warning:the operation 'count' for the output column 'Diagnostic' can't be processed because of incompatible input and/or output types");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						operation_finder_tAggregateRow_1.Diagnostic = row1.Diagnostic;
						...
						if (operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
							...
							operation_result_tAggregateRow_1.Diagnostic = operation_finder_tAggregateRow_1.Diagnostic;
...
///////////////////////    			
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row2.Diagnostic = aggregated_row_tAggregateRow_1.Diagnostic;
...
///////////////////////		
					...
					if (row2.Code_diag != null) { //
						...
						strBuffer_tLogRow_1.append(String.valueOf(row2.Code_diag));
					...
					if (row2.Diagnostic != null) { //
						...
						strBuffer_tLogRow_1.append(String.valueOf(row2.Diagnostic));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final diagnostic_job diagnostic_jobClass = new diagnostic_job();

		int exitCode = diagnostic_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = diagnostic_job.class.getClassLoader()
					.getResourceAsStream("etl_project/diagnostic_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = diagnostic_job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : diagnostic_job");
		}
...
/************************************************************************************************
 * 83863 characters generated by Talend Open Studio for Big Data on the 24
 * octobre 2025 10:23:00 CEST
 ************************************************************************************************/