...
// Start of branch "row_Implicit_Context_Regex"
	...
	public static class region_deces_outputStruct
			implements routines.system.IPersistableRow<region_deces_outputStruct> {
		final static byte[] commonByteArrayLock_ETL_PROJECT_AggregateRegions_job = new byte[0];
		static byte[] commonByteArray_ETL_PROJECT_AggregateRegions_job = new byte[0];
...
// # Output table : 'region_deces_output'
								region_deces_output_tmp.code_lieu_naissance = row1.code_lieu_naissance;
								region_deces_output_tmp.lieu_naissance = row1.lieu_naissance;
								region_deces_output_tmp.pays_naissance = row1.pays_naissance;
								region_deces_output_tmp.code_lieu_deces = row1.code_lieu_deces;
...
///////////////////////		
								...
								if (region_deces_output.code_lieu_naissance != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(region_deces_output.code_lieu_naissance));

								} //

								strBuffer_tLogRow_1.append("|");

								if (region_deces_output.lieu_naissance != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(region_deces_output.lieu_naissance));

								} //

								strBuffer_tLogRow_1.append("|");

								if (region_deces_output.pays_naissance != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(region_deces_output.pays_naissance));

								} //

								strBuffer_tLogRow_1.append("|");

								if (region_deces_output.code_lieu_deces != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(region_deces_output.code_lieu_deces));
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = AggregateRegions_job.class.getClassLoader()
					.getResourceAsStream("etl_project/aggregateregions_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = AggregateRegions_job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : AggregateRegions_job");
		}
...
/************************************************************************************************
 * 70810 characters generated by Talend Open Studio for Big Data on the 24
 * octobre 2025 14:51:37 CEST
 ************************************************************************************************/