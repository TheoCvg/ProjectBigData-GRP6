...
package etl_project.healthcare_professionnal_0_1;
...
/**
 * Job: healthcare_professionnal Purpose: healthcare_professionnal<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class healthcare_professionnal implements TalendJob {
	...
	private final String jobName = "healthcare_professionnal";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					healthcare_professionnal.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(healthcare_professionnal.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row_Implicit_Context_RegexStruct
		...
		final static byte[] commonByteArrayLock_ETL_PROJECT_healthcare_professionnal = new byte[0];
		static byte[] commonByteArray_ETL_PROJECT_healthcare_professionnal = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ETL_PROJECT_healthcare_professionnal.length) {
					if (length < 1024 && commonByteArray_ETL_PROJECT_healthcare_professionnal.length == 0) {
						commonByteArray_ETL_PROJECT_healthcare_professionnal = new byte[1024];
					} else {
						commonByteArray_ETL_PROJECT_healthcare_professionnal = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ETL_PROJECT_healthcare_professionnal, 0, length);
				strReturn = new String(commonByteArray_ETL_PROJECT_healthcare_professionnal, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PROJECT_healthcare_professionnal) {
...
///////////////////////		
								...
								if (d_healthcare_professionnel.identifiant != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(d_healthcare_professionnel.identifiant));

								} //

								strBuffer_tLogRow_1.append("|");

								if (d_healthcare_professionnel.nom != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(d_healthcare_professionnel.nom));

								} //

								strBuffer_tLogRow_1.append("|");

								if (d_healthcare_professionnel.prenom != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(d_healthcare_professionnel.prenom));
								...
								if (d_healthcare_professionnel.profession != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(d_healthcare_professionnel.profession));

								} //

								strBuffer_tLogRow_1.append("|");

								if (d_healthcare_professionnel.specialite != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(d_healthcare_professionnel.specialite));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final healthcare_professionnal healthcare_professionnalClass = new healthcare_professionnal();

		int exitCode = healthcare_professionnalClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = healthcare_professionnal.class.getClassLoader().getResourceAsStream(
					"etl_project/healthcare_professionnal_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = healthcare_professionnal.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : healthcare_professionnal");
		}
...
/************************************************************************************************
 * 71593 characters generated by Talend Open Studio for Big Data on the 24
 * octobre 2025 11:57:46 CEST
 ************************************************************************************************/