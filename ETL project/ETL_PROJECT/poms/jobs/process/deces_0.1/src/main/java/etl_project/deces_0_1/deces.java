...
public class deces implements TalendJob {
	...
	public static class row_Implicit_Context_RegexStruct
		...
		final static byte[] commonByteArrayLock_ETL_PROJECT_deces = new byte[0];
		static byte[] commonByteArray_ETL_PROJECT_deces = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ETL_PROJECT_deces.length) {
					if (length < 1024 && commonByteArray_ETL_PROJECT_deces.length == 0) {
						commonByteArray_ETL_PROJECT_deces = new byte[1024];
					} else {
						commonByteArray_ETL_PROJECT_deces = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ETL_PROJECT_deces, 0, length);
				strReturn = new String(commonByteArray_ETL_PROJECT_deces, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PROJECT_deces) {
...
// Start of branch "row_Implicit_Context_Regex"
	...
	public static class deceaseStruct implements routines.system.IPersistableRow<deceaseStruct> {
		final static byte[] commonByteArrayLock_ETL_PROJECT_deces = new byte[0];
		static byte[] commonByteArray_ETL_PROJECT_deces = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(deceaseStruct other) {
	...
	public static class dateStruct implements routines.system.IPersistableRow<dateStruct> {
		...
		public java.util.Date date_dece;

		public java.util.Date getDate_dece() {
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("date_dece=" + String.valueOf(date_dece));
			sb.append("]");
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deceaseStruct decease = new deceaseStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "decease");
				}
...
// # Vars initialization
				class Var__tMap_1__Struct {
					java.util.Date date_naissance;
					java.util.Date date_dece;
					int age;
				}
...
// # Outputs initialization
				deceaseStruct decease_tmp = new deceaseStruct();
...
// ###############################
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */
						context.INPUT_PATH + "deces.csv"/** End field tFileInputDelimited_2:FILENAME */
				;
						...
						try {
							...
							if (rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])) {// empty
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.prenom = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.date_naissance = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.code_lieu_naissance = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.lieu_naissance = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.pays_naissance = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.date_deces = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.code_lieu_deces = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.numero_acte_deces = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
// Start of branch "row1"
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								Var.date_naissance = row1.date_naissance == null || row1.date_naissance.trim().isEmpty()
										? null
										: (TalendDate.isDate(row1.date_naissance.trim(), "yyyy-MM-dd")
												? TalendDate.parseDate("yyyy-MM-dd", row1.date_naissance.trim())
												: (TalendDate.isDate(row1.date_naissance.trim(), "yyyy-MM")
														? TalendDate.parseDate("yyyy-MM", row1.date_naissance.trim())
														: (TalendDate.isDate(row1.date_naissance.trim(), "yyyy")
																? TalendDate.parseDate("yyyy",
																		row1.date_naissance.trim())
																: null)));
								Var.date_dece = row1.date_deces == null || row1.date_deces.trim().isEmpty() ? null
										: (TalendDate.isDate(row1.date_deces.trim(), "yyyy-MM-dd")
												? TalendDate.parseDate("yyyy-MM-dd", row1.date_deces.trim())
												: (TalendDate.isDate(row1.date_deces.trim(), "yyyy-MM")
														? TalendDate.parseDate("yyyy-MM", row1.date_deces.trim())
														: (TalendDate.isDate(row1.date_deces.trim(), "yyyy")
																? TalendDate.parseDate("yyyy", row1.date_deces.trim()) // ->
																														// 1er
																														// janv.
																														// par
																														// défaut
																: null)));
								Var.age = TalendDate.diffDateFloor(Var.date_dece, Var.date_naissance, "yyyy");// ###############################
								// ###############################
								// # Output tables
...
// # Output table : 'decease'
								decease_tmp.numero_acte_deces = row1.numero_acte_deces;
								decease = decease_tmp;

// # Output table : 'patient'
								patient_tmp.sexe = row1.sexe;
								patient_tmp.age = Var.age;
								patient = patient_tmp;

// # Output table : 'date'
								date_tmp.date_dece = Var.date_dece;
								date = date_tmp;

// # Output table : 'region'
								region_tmp.Postcode = row1.code_lieu_deces;
								region = region_tmp;
// ###############################
...
// Start of branch "decease"
							if (decease != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "decease");
								}
...
///////////////////////		
								...
								if (decease.numero_acte_deces != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(decease.numero_acte_deces));
...
///////////////////////		
								...
								if (patient.sexe != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(patient.sexe));

								} //

								strBuffer_tLogRow_2.append("|");

								strBuffer_tLogRow_2.append(String.valueOf(patient.age));
...
// Start of branch "date"
							if (date != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "date");
								}
...
///////////////////////		
								...
								if (date.date_dece != null) { //

									strBuffer_tLogRow_3
											.append(FormatterUtils.format_Date(date.date_dece, "dd-MM-yyyy"));
...
///////////////////////		
								...
								if (region.Postcode != null) { //
									...
									strBuffer_tLogRow_4.append(String.valueOf(region.Postcode));
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "decease");
				}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = deces.class.getClassLoader()
					.getResourceAsStream("etl_project/deces_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 97988 characters generated by Talend Open Studio for Big Data on the 24
 * octobre 2025 11:02:13 CEST
 ************************************************************************************************/