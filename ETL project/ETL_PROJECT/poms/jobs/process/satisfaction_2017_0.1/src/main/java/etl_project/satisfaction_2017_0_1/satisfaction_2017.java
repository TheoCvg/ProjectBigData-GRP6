...
package etl_project.satisfaction_2017_0_1;
...
/**
 * Job: satisfaction_2017 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class satisfaction_2017 implements TalendJob {
	...
	private final String jobName = "satisfaction_2017";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					satisfaction_2017.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(satisfaction_2017.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row_Implicit_Context_RegexStruct
		...
		final static byte[] commonByteArrayLock_ETL_PROJECT_satisfaction_2017 = new byte[0];
		static byte[] commonByteArray_ETL_PROJECT_satisfaction_2017 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ETL_PROJECT_satisfaction_2017.length) {
					if (length < 1024 && commonByteArray_ETL_PROJECT_satisfaction_2017.length == 0) {
						commonByteArray_ETL_PROJECT_satisfaction_2017 = new byte[1024];
					} else {
						commonByteArray_ETL_PROJECT_satisfaction_2017 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ETL_PROJECT_satisfaction_2017, 0, length);
				strReturn = new String(commonByteArray_ETL_PROJECT_satisfaction_2017, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PROJECT_satisfaction_2017) {
...
// Start of branch "row_Implicit_Context_Regex"
	...
	public static class satisfactionStruct implements routines.system.IPersistableRow<satisfactionStruct> {
		...
		public Float score_acceuil;

		public Float getScore_acceuil() {
			...
			synchronized (commonByteArrayLock_ETL_PROJECT_satisfaction_2017) {
				...
				try {
					...
					if (length == -1) {
						...
						this.score_acceuil = dis.readFloat();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.score_acceuil == null) {
					...
					dos.writeByte(0);
					dos.writeFloat(this.score_acceuil);
				}
...
// ###############################
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */
						context.INPUT_PATH
								+ "ESATIS48H_MCO_recueil2017_donnees.csv"/** End field tFileInputDelimited_2:FILENAME */
				;
						...
						try {
							...
							if (rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])) {// empty
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.finess = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.rs_finess = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.finess_geo = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.rs_finess_geo = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.participation = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.Depot = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.nb_rep_score_all_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.score_all_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.classement = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.evolution = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.nb_rep_score_accueil_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.score_accueil_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.nb_rep_score_PECinf_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.score_PECinf_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.nb_rep_score_PECmed_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.score_PECmed_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.nb_rep_score_chambre_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.score_chambre_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.nb_rep_score_repas_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.score_repas_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.nb_rep_score_sortie_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.score_sortie_rea_ajust = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
// # Output table : 'satisfaction'
								...
								satisfaction_tmp.score_acceuil = (row1.score_accueil_rea_ajust == null
										|| row1.score_accueil_rea_ajust.trim().equals("")) ? null
												: Float.parseFloat(row1.score_accueil_rea_ajust.replace(",", "."));
								satisfaction_tmp.score_prise_en_charge_inf = (row1.score_PECinf_rea_ajust == null
										|| row1.score_PECinf_rea_ajust.trim().equals("")) ? null
												: Float.parseFloat(row1.score_PECinf_rea_ajust.replace(",", "."));
								satisfaction_tmp.score_prise_en_charge_med = (row1.score_PECmed_rea_ajust == null
										|| row1.score_PECmed_rea_ajust.trim().equals("")) ? null
												: Float.parseFloat(row1.score_PECmed_rea_ajust.replace(",", "."));
								satisfaction_tmp.score_chambre = (row1.score_chambre_rea_ajust == null
										|| row1.score_chambre_rea_ajust.trim().equals("")) ? null
												: Float.parseFloat(row1.score_chambre_rea_ajust.replace(",", "."));
								satisfaction_tmp.score_repas = (row1.score_repas_rea_ajust == null
										|| row1.score_repas_rea_ajust.trim().equals("")) ? null
												: Float.parseFloat(row1.score_repas_rea_ajust.replace(",", "."));
								satisfaction_tmp.score_sortie = (row1.score_sortie_rea_ajust == null
										|| row1.score_sortie_rea_ajust.trim().equals("")) ? null
												: Float.parseFloat(row1.score_sortie_rea_ajust.replace(",", "."));
								satisfaction = satisfaction_tmp;

// # Output table : 'test'
								test_tmp.finess = row1.finess;
								test_tmp.score_accueil_rea_ajust = row1.score_accueil_rea_ajust;
								test_tmp.score_PECinf_rea_ajust = row1.score_PECinf_rea_ajust;
								test_tmp.score_PECmed_rea_ajust = row1.score_PECmed_rea_ajust;
								test_tmp.score_chambre_rea_ajust = row1.score_chambre_rea_ajust;
								test_tmp.score_repas_rea_ajust = row1.score_repas_rea_ajust;
								test_tmp.score_sortie_rea_ajust = row1.score_sortie_rea_ajust;
								test = test_tmp;
// ###############################
...
///////////////////////		
								...
								if (satisfaction.finess != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(satisfaction.finess));

								} //

								strBuffer_tLogRow_2.append("|");

								if (satisfaction.score_acceuil != null) { //

									strBuffer_tLogRow_2
											.append(FormatterUtils.formatUnwithE(satisfaction.score_acceuil));
								...
								if (satisfaction.score_repas != null) { //
									...
									strBuffer_tLogRow_2.append(FormatterUtils.formatUnwithE(satisfaction.score_repas));
								...
								if (satisfaction.score_sortie != null) { //
									...
									strBuffer_tLogRow_2.append(FormatterUtils.formatUnwithE(satisfaction.score_sortie));
...
///////////////////////		
								...
								if (test.finess != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(test.finess));

								} //

								strBuffer_tLogRow_1.append("|");

								if (test.score_accueil_rea_ajust != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(test.score_accueil_rea_ajust));

								} //

								strBuffer_tLogRow_1.append("|");

								if (test.score_PECinf_rea_ajust != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(test.score_PECinf_rea_ajust));

								} //

								strBuffer_tLogRow_1.append("|");

								if (test.score_PECmed_rea_ajust != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(test.score_PECmed_rea_ajust));

								} //

								strBuffer_tLogRow_1.append("|");

								if (test.score_chambre_rea_ajust != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(test.score_chambre_rea_ajust));

								} //

								strBuffer_tLogRow_1.append("|");

								if (test.score_repas_rea_ajust != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(test.score_repas_rea_ajust));

								} //

								strBuffer_tLogRow_1.append("|");

								if (test.score_sortie_rea_ajust != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(test.score_sortie_rea_ajust));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final satisfaction_2017 satisfaction_2017Class = new satisfaction_2017();

		int exitCode = satisfaction_2017Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = satisfaction_2017.class.getClassLoader()
					.getResourceAsStream("etl_project/satisfaction_2017_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = satisfaction_2017.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : satisfaction_2017");
		}
...
/************************************************************************************************
 * 106089 characters generated by Talend Open Studio for Big Data on the 24
 * octobre 2025 13:33:02 CEST
 ************************************************************************************************/