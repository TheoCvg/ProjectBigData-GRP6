...
// Start of branch "row_Implicit_Context_Regex"
	...
	public static class patient_decease_outputStruct
			implements routines.system.IPersistableRow<patient_decease_outputStruct> {
		final static byte[] commonByteArrayLock_ETL_PROJECT_AggregatePatients_job = new byte[0];
		static byte[] commonByteArray_ETL_PROJECT_AggregatePatients_job = new byte[0];
...
///////////////////////		
									...
									strBuffer_tLogRow_1.append(String.valueOf(patient_output.Id_patient));

									strBuffer_tLogRow_1.append("|");

									if (patient_output.IsFemale != null) { //

										strBuffer_tLogRow_1.append(String.valueOf(patient_output.IsFemale));
									...
									if (patient_output.Age != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(patient_output.Age));
									...
									if (patient_output.Weight != null) { //
										...
										strBuffer_tLogRow_1.append(FormatterUtils.formatUnwithE(patient_output.Weight));
									...
									if (patient_output.Size != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(patient_output.Size));
									...
									if (patient_output.Email != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(patient_output.Email));
...
///////////////////////		
										...
										if (patient_output.Weight != null) { //
											...
											strBuffer_tLogRow_1
													.append(FormatterUtils.formatUnwithE(patient_output.Weight));
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "d_patient_output", "patient_decease_output");
				}
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = AggregatePatients_job.class.getClassLoader().getResourceAsStream(
					"etl_project/aggregatepatients_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = AggregatePatients_job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : AggregatePatients_job");
		}
...
/************************************************************************************************
 * 143385 characters generated by Talend Open Studio for Big Data on the 24
 * octobre 2025 15:17:52 CEST
 ************************************************************************************************/