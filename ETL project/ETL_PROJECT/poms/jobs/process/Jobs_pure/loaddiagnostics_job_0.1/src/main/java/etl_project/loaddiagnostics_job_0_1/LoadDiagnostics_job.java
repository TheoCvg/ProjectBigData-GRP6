...
package etl_project.loaddiagnostics_job_0_1;
...
/**
 * Job: LoadDiagnostics_job Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class LoadDiagnostics_job implements TalendJob {
...
public String getPostgres_DB_input_AdditionalParams(){
	...
	private final String jobName = "LoadDiagnostics_job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LoadDiagnostics_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LoadDiagnostics_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/cloudera/hive/warehouse/chu.db/d_diagnostic.txt");
 ...
 */
	...
	currentComponent="tHDFSOutput_1";
					...
					writer_tHDFSOutput_1.append(new org.apache.hadoop.io.Text(row1.Code_diag),new org.apache.hadoop.io.Text(row1.Code_diag));
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
	...
	final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Yw+9zCDO6Pn+/3Z/hcHF6JrTfjGu4pYuNwDPdw==");
 ...
 */
    ...
    public static void main(String[] args){
        final LoadDiagnostics_job LoadDiagnostics_jobClass = new LoadDiagnostics_job();

        int exitCode = LoadDiagnostics_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LoadDiagnostics_job.class.getClassLoader().getResourceAsStream("etl_project/loaddiagnostics_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LoadDiagnostics_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LoadDiagnostics_job");
        }
...
/************************************************************************************************
 *     73303 characters generated by Talend Open Studio for Big Data 
 *     on the 24 octobre 2025 19:03:46 CEST
 ************************************************************************************************/