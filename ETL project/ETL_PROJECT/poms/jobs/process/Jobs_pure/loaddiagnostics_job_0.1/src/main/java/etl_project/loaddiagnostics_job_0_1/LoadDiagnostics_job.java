...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LoadDiagnostics_job.class.getClassLoader()
					.getResourceAsStream("etl_project/loaddiagnostics_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = LoadDiagnostics_job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : LoadDiagnostics_job");
		}
