...
// ###############################
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "dates_hospitalization_output",
							"date_naissance_output", "row1");
				}
...
///////////////////////		
								...
								if (d_dates_output.Date != null) { //
									...
									strBuffer_tLogRow_1
											.append(FormatterUtils.format_Date(d_dates_output.Date, "dd-MM-yyyy"));
...
// # Output table : 'dates_hospitalization_output'
								dates_hospitalization_output_tmp.Date = TalendDate.parseDate("dd-MM-yyyy",
										row3.Date_Entree);
...
///////////////////////		
										...
										if (d_dates_output.Date != null) { //
											...
											strBuffer_tLogRow_1.append(
													FormatterUtils.format_Date(d_dates_output.Date, "dd-MM-yyyy"));
...
// # Output table : 'date_naissance_output'
								date_naissance_output_tmp.Date = TalendDate.parseDate("dd-MM-yyyy",
										row2.date_naissance);
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "dates_hospitalization_output",
							"date_naissance_output", "row1");
				}
...
/************************************************************************************************
 * 131448 characters generated by Talend Open Studio for Big Data on the 24
 * octobre 2025 16:26:10 CEST
 ************************************************************************************************/