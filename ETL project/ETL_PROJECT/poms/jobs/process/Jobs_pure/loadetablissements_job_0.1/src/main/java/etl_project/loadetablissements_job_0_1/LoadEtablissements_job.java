...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/cloudera/hive/warehouse/chu.db/d_etablissement.txt");
	int nb_line_tHDFSOutput_1 = 0;
			...
			org.apache.hadoop.io.SequenceFile.Writer writer_tHDFSOutput_1 = new org.apache.hadoop.io.SequenceFile.Writer(fs_tHDFSOutput_1, conf_tHDFSOutput_1, path_tHDFSOutput_1, org.apache.hadoop.io.IntWritable.class, org.apache.hadoop.io.IntWritable.class);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */context.INPUT_PATH + "etablissement_sante.csv"/** End field tFileInputDelimited_2:FILENAME */;		
...
if(d_etablissement != null) { 
	...
	currentComponent="tHDFSOutput_1";
					...
					writer_tHDFSOutput_1.append(new org.apache.hadoop.io.IntWritable(d_etablissement.id_eta),new org.apache.hadoop.io.IntWritable(d_etablissement.id_eta));
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
	...
	final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:EDGWXECJNH8Ux/+1Rs2dUjDWksDfKVWCN8NE0A==");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LoadEtablissements_job.class.getClassLoader().getResourceAsStream("etl_project/loadetablissements_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LoadEtablissements_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LoadEtablissements_job");
        }
...
/************************************************************************************************
 *     100611 characters generated by Talend Open Studio for Big Data 
 *     on the 24 octobre 2025 19:03:48 CEST
 ************************************************************************************************/