...
package etl_project.loadhealthcareprofessionnals_job_0_1;
...
/**
 * Job: LoadHealthcareProfessionnals_job Purpose: healthcare_professionnal<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class LoadHealthcareProfessionnals_job implements TalendJob {
...
public String getINPUT_PATH(){
	...
	private final String jobName = "LoadHealthcareProfessionnals_job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LoadHealthcareProfessionnals_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LoadHealthcareProfessionnals_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_ETL_PROJECT_LoadHealthcareProfessionnals_job = new byte[0];
    static byte[] commonByteArray_ETL_PROJECT_LoadHealthcareProfessionnals_job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ETL_PROJECT_LoadHealthcareProfessionnals_job.length) {
				if(length < 1024 && commonByteArray_ETL_PROJECT_LoadHealthcareProfessionnals_job.length == 0) {
   					commonByteArray_ETL_PROJECT_LoadHealthcareProfessionnals_job = new byte[1024];
				} else {
   					commonByteArray_ETL_PROJECT_LoadHealthcareProfessionnals_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ETL_PROJECT_LoadHealthcareProfessionnals_job, 0, length);
			strReturn = new String(commonByteArray_ETL_PROJECT_LoadHealthcareProfessionnals_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ETL_PROJECT_LoadHealthcareProfessionnals_job) {
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/cloudera/hive/warehouse/chu.db/d_healthcare_professionnal.txt");
	int nb_line_tHDFSOutput_1 = 0;
			...
			org.apache.hadoop.io.SequenceFile.Writer writer_tHDFSOutput_1 = new org.apache.hadoop.io.SequenceFile.Writer(fs_tHDFSOutput_1, conf_tHDFSOutput_1, path_tHDFSOutput_1, org.apache.hadoop.io.Text.class, org.apache.hadoop.io.Text.class);
...
d_healthcare_professionnel_tmp.identifiant = row1.identifiant ;
d_healthcare_professionnel_tmp.nom = row1.nom ;
d_healthcare_professionnel_tmp.prenom = row1.prenom ;
d_healthcare_professionnel_tmp.profession = row1.profession ;
d_healthcare_professionnel_tmp.specialite = row1.specialite ;
...
if(d_healthcare_professionnel != null) { 
	...
	currentComponent="tHDFSOutput_1";
					...
					writer_tHDFSOutput_1.append(new org.apache.hadoop.io.Text(d_healthcare_professionnel.identifiant),new org.apache.hadoop.io.Text(d_healthcare_professionnel.identifiant));
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
	...
	final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Vu5sNkbmMOo9DE7Jm4A5JUkDAeScKEWbKmX2Qg==");
...
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "() STORED BY '" + storageClass_tHiveCreateTable_1 + "' LOCATION '" + location_tHiveCreateTable_1 + "'";
		try {
 ...
 */
    ...
    public static void main(String[] args){
        final LoadHealthcareProfessionnals_job LoadHealthcareProfessionnals_jobClass = new LoadHealthcareProfessionnals_job();

        int exitCode = LoadHealthcareProfessionnals_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LoadHealthcareProfessionnals_job.class.getClassLoader().getResourceAsStream("etl_project/loadhealthcareprofessionnals_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LoadHealthcareProfessionnals_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LoadHealthcareProfessionnals_job");
        }
...
/************************************************************************************************
 *     78964 characters generated by Talend Open Studio for Big Data 
 *     on the 24 octobre 2025 19:03:47 CEST
 ************************************************************************************************/