...
package etl_project.aggregateregions_job_0_1;
...
/**
 * Job: AggregateRegions_job Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class AggregateRegions_job implements TalendJob {
...
public String getINPUT_PATH(){
	...
	private final String jobName = "AggregateRegions_job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				AggregateRegions_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(AggregateRegions_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_ETL_PROJECT_AggregateRegions_job = new byte[0];
    static byte[] commonByteArray_ETL_PROJECT_AggregateRegions_job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ETL_PROJECT_AggregateRegions_job.length) {
				if(length < 1024 && commonByteArray_ETL_PROJECT_AggregateRegions_job.length == 0) {
   					commonByteArray_ETL_PROJECT_AggregateRegions_job = new byte[1024];
				} else {
   					commonByteArray_ETL_PROJECT_AggregateRegions_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ETL_PROJECT_AggregateRegions_job, 0, length);
			strReturn = new String(commonByteArray_ETL_PROJECT_AggregateRegions_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ETL_PROJECT_AggregateRegions_job) {
...
public static class region_deces_outputStruct implements routines.system.IPersistableRow<region_deces_outputStruct> {
    final static byte[] commonByteArrayLock_ETL_PROJECT_AggregateRegions_job = new byte[0];
    static byte[] commonByteArray_ETL_PROJECT_AggregateRegions_job = new byte[0];
		...
		synchronized(commonByteArrayLock_ETL_PROJECT_AggregateRegions_job) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.BirthCountry = readString(dis);
					
					this.BirthTown = readString(dis);
					
					this.BirthPostalCode = readString(dis);
					
					this.DeathPostalCode = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.BirthCountry,dos);
					
					// String
				
						writeString(this.BirthTown,dos);
					
					// String
				
						writeString(this.BirthPostalCode,dos);
					
					// String
				
						writeString(this.DeathPostalCode,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("BirthCountry="+BirthCountry);
		sb.append(",BirthTown="+BirthTown);
		sb.append(",BirthPostalCode="+BirthPostalCode);
		sb.append(",DeathPostalCode="+DeathPostalCode);
	    sb.append("]");
     ...
     * Compare keys
     */
    public int compareTo(region_deces_outputStruct other) {
...
region_deces_outputStruct region_deces_output = new region_deces_outputStruct();
	...
	currentComponent="tHDFSOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"region_deces_output");
					}
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/cloudera/hive/warehouse/chu.db/d_region.txt");
...
region_deces_outputStruct region_deces_output_tmp = new region_deces_outputStruct();
// ###############################
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.sexe = ParserUtils.parseTo_Integer(temp);
					...
					columnIndexWithD_tFileInputDelimited_1 = 4;
							...
							row1.code_lieu_naissance = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 8;
							...
							row1.code_lieu_deces = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 9;
					
							row1.numero_acte_deces = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
region_deces_output = null;


// # Output table : 'region_deces_output'
region_deces_output_tmp.BirthCountry = row1.pays_naissance ;
region_deces_output_tmp.BirthTown = row1.lieu_naissance ;
region_deces_output_tmp.BirthPostalCode = row1.code_lieu_naissance ;
region_deces_output_tmp.DeathPostalCode = row1.code_lieu_deces ;
region_deces_output = region_deces_output_tmp;
// ###############################
 ...
 */
// Start of branch "region_deces_output"
if(region_deces_output != null) { 
	...
	currentComponent="tHDFSOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"region_deces_output");
					}
					...
					writer_tHDFSOutput_1.append(new org.apache.hadoop.io.Text(region_deces_output.BirthCountry),new org.apache.hadoop.io.Text(region_deces_output.BirthCountry));
...
} // End of branch "region_deces_output"
 ...
 */
	...
	currentComponent="tHDFSOutput_1";
		...
		writer_tHDFSOutput_1.close();
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"region_deces_output");
			  	}
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
	...
	final String decryptedPassword_tHiveCreateTable_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:NYxMySyNNNY486y6iMX1R8zPsrNEbnuVQXRjVg==");
 ...
 */
    ...
    public static void main(String[] args){
        final AggregateRegions_job AggregateRegions_jobClass = new AggregateRegions_job();

        int exitCode = AggregateRegions_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = AggregateRegions_job.class.getClassLoader().getResourceAsStream("etl_project/aggregateregions_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = AggregateRegions_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : AggregateRegions_job");
        }
...
/************************************************************************************************
 *     78061 characters generated by Talend Open Studio for Big Data 
 *     on the 24 octobre 2025 19:03:45 CEST
 ************************************************************************************************/