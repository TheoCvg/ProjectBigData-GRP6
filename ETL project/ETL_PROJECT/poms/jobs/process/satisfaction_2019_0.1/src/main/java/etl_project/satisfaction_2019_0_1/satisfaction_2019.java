...
package etl_project.satisfaction_2019_0_1;
...
/**
 * Job: satisfaction_2019 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class satisfaction_2019 implements TalendJob {
	...
	private final String jobName = "satisfaction_2019";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					satisfaction_2019.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(satisfaction_2019.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row_Implicit_Context_RegexStruct
		...
		final static byte[] commonByteArrayLock_ETL_PROJECT_satisfaction_2019 = new byte[0];
		static byte[] commonByteArray_ETL_PROJECT_satisfaction_2019 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ETL_PROJECT_satisfaction_2019.length) {
					if (length < 1024 && commonByteArray_ETL_PROJECT_satisfaction_2019.length == 0) {
						commonByteArray_ETL_PROJECT_satisfaction_2019 = new byte[1024];
					} else {
						commonByteArray_ETL_PROJECT_satisfaction_2019 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ETL_PROJECT_satisfaction_2019, 0, length);
				strReturn = new String(commonByteArray_ETL_PROJECT_satisfaction_2019, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PROJECT_satisfaction_2019) {
...
// Start of branch "row_Implicit_Context_Regex"
	...
	public static class satisfactionStruct implements routines.system.IPersistableRow<satisfactionStruct> {
		...
		public Float score_PECinf;

		public Float getScore_PECinf() {
			return this.score_PECinf;
		}

		public Float score_PECmed;

		public Float getScore_PECmed() {
			return this.score_PECmed;
		}
		...
		public Float taux_recommendation;

		public Float getTaux_recommendation() {
			return this.taux_recommendation;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PROJECT_satisfaction_2019) {
				...
				try {
					...
					length = dis.readByte();
					if (length == -1) {
						this.score_PECinf = null;
					} else {
						this.score_PECinf = dis.readFloat();
					}

					length = dis.readByte();
					if (length == -1) {
						this.score_PECmed = null;
					} else {
						this.score_PECmed = dis.readFloat();
					}
					...
					length = dis.readByte();
					if (length == -1) {
						this.taux_recommendation = null;
					} else {
						this.taux_recommendation = dis.readFloat();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.score_PECinf == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeFloat(this.score_PECinf);
				}

				// Float

				if (this.score_PECmed == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeFloat(this.score_PECmed);
				}
				...
				if (this.taux_recommendation == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeFloat(this.taux_recommendation);
				}
		...
		public String toString() {
			...
			sb.append(",score_PECinf=" + String.valueOf(score_PECinf));
			sb.append(",score_PECmed=" + String.valueOf(score_PECmed));
			...
			sb.append(",taux_recommendation=" + String.valueOf(taux_recommendation));
			sb.append("]");
...
// ###############################
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */
						context.INPUT_PATH + "resultats-esatis48h-mco-open-data-2019.csv"/**
																							 * End field
						...
						try {
							...
							if (rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])) {// empty
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.finess = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.rs_finess = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.finess_geo = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.rs_finess_geo = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.participation = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.Depot = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.nb_rep_score_all_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.score_all_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.classement = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.evolution = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.nb_rep_score_accueil_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.score_accueil_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.nb_rep_score_PECinf_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.score_PECinf_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.nb_rep_score_PECmed_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.score_PECmed_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.nb_rep_score_chambre_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.score_chambre_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.nb_rep_score_repas_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.score_repas_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.nb_rep_score_sortie_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.score_sortie_rea_ajust = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.taux_reco_brut = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.nb_reco_brut = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
// # Output table : 'satisfaction'
								...
								satisfaction_tmp.taux_recommendation = (row1.taux_reco_brut == null
...
///////////////////////		
								...
								if (satisfaction.score_PECinf != null) { //

									strBuffer_tLogRow_1.append(FormatterUtils.formatUnwithE(satisfaction.score_PECinf));

								} //

								strBuffer_tLogRow_1.append("|");

								if (satisfaction.score_PECmed != null) { //

									strBuffer_tLogRow_1.append(FormatterUtils.formatUnwithE(satisfaction.score_PECmed));
								...
								if (satisfaction.score_repas != null) { //
									...
									strBuffer_tLogRow_1.append(FormatterUtils.formatUnwithE(satisfaction.score_repas));
								...
								if (satisfaction.score_sortie != null) { //
									...
									strBuffer_tLogRow_1.append(FormatterUtils.formatUnwithE(satisfaction.score_sortie));

								} //

								strBuffer_tLogRow_1.append("|");

								if (satisfaction.taux_recommendation != null) { //

									strBuffer_tLogRow_1
											.append(FormatterUtils.formatUnwithE(satisfaction.taux_recommendation));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final satisfaction_2019 satisfaction_2019Class = new satisfaction_2019();

		int exitCode = satisfaction_2019Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = satisfaction_2019.class.getClassLoader()
					.getResourceAsStream("etl_project/satisfaction_2019_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = satisfaction_2019.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : satisfaction_2019");
		}
...
/************************************************************************************************
 * 98003 characters generated by Talend Open Studio for Big Data on the 24
 * octobre 2025 13:48:09 CEST
 ************************************************************************************************/