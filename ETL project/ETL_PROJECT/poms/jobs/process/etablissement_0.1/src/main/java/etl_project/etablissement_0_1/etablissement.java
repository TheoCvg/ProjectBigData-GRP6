...
package etl_project.etablissement_0_1;
...
/**
 * Job: etablissement Purpose: etablissement<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class etablissement implements TalendJob {
	...
	private final String jobName = "etablissement";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					etablissement.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(etablissement.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row_Implicit_Context_RegexStruct
		...
		final static byte[] commonByteArrayLock_ETL_PROJECT_etablissement = new byte[0];
		static byte[] commonByteArray_ETL_PROJECT_etablissement = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ETL_PROJECT_etablissement.length) {
					if (length < 1024 && commonByteArray_ETL_PROJECT_etablissement.length == 0) {
						commonByteArray_ETL_PROJECT_etablissement = new byte[1024];
					} else {
						commonByteArray_ETL_PROJECT_etablissement = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ETL_PROJECT_etablissement, 0, length);
				strReturn = new String(commonByteArray_ETL_PROJECT_etablissement, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PROJECT_etablissement) {
...
///////////////////////		
								...
								strBuffer_tLogRow_1.append(String.valueOf(d_etablissement.id_eta));

								strBuffer_tLogRow_1.append("|");

								if (d_etablissement.raison_sociale_site != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(d_etablissement.raison_sociale_site));
								...
								if (d_etablissement.cedex != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(d_etablissement.cedex));
								...
								if (d_etablissement.email != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(d_etablissement.email));
								...
								if (d_etablissement.identifiant_organisation != null) { //
									...
									strBuffer_tLogRow_1
											.append(String.valueOf(d_etablissement.identifiant_organisation));
								...
								if (d_etablissement.siren_site != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(d_etablissement.siren_site));
								...
								if (d_etablissement.siret_site != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(d_etablissement.siret_site));
								...
								if (d_etablissement.telecopie != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(d_etablissement.telecopie));
								...
								if (d_etablissement.telephone != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(d_etablissement.telephone));
								...
								if (d_etablissement.telephone_2 != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(d_etablissement.telephone_2));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final etablissement etablissementClass = new etablissement();

		int exitCode = etablissementClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = etablissement.class.getClassLoader()
					.getResourceAsStream("etl_project/etablissement_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = etablissement.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : etablissement");
		}
...
/************************************************************************************************
 * 94632 characters generated by Talend Open Studio for Big Data on the 24
 * octobre 2025 11:56:17 CEST
 ************************************************************************************************/