...
package etl_project.satisfaction_0_1;
 ...
 * @status
 */
public class satisfaction implements TalendJob {
	...
	private final String jobName = "satisfaction";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(satisfaction.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row_Implicit_Context_RegexStruct
		...
		final static byte[] commonByteArrayLock_ETL_PROJECT_satisfaction = new byte[0];
		static byte[] commonByteArray_ETL_PROJECT_satisfaction = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ETL_PROJECT_satisfaction.length) {
					if (length < 1024 && commonByteArray_ETL_PROJECT_satisfaction.length == 0) {
						commonByteArray_ETL_PROJECT_satisfaction = new byte[1024];
					} else {
						commonByteArray_ETL_PROJECT_satisfaction = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ETL_PROJECT_satisfaction, 0, length);
				strReturn = new String(commonByteArray_ETL_PROJECT_satisfaction, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PROJECT_satisfaction) {
...
///////////////////////    			
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.INPUT_PATH
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.INPUT_PATH + "DPA_SSR_recueil2014_donnee2013_table_es.csv", "ISO-8859-15", ";",
...
///////////////////////    			
					...
					if (!((Object) (context.INPUT_PATH
							+ "DPA_SSR_recueil2014_donnee2013_table_es.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final satisfaction satisfactionClass = new satisfaction();

		int exitCode = satisfactionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = satisfaction.class.getClassLoader()
					.getResourceAsStream("etl_project/satisfaction_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = satisfaction.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : satisfaction");
		}
...
/************************************************************************************************
 * 54515 characters generated by Talend Open Studio for Big Data on the 24
 * octobre 2025 11:46:55 CEST
 ************************************************************************************************/